...
class TestDogmModels(unittest.TestCase):
    ...
    def test_gdb_datasoure_normalization(self):
        ...
        model = models.OgmResult(gdb_data, Normalizer())
        actual = model.row
...
class TestCharges(unittest.TestCase):
    ...
    def setUp(self):
        self.patient = models.Charges()

    def test_update_noop_if_detect_cond(self):
        self.patient.update('ca', 1, 'Bad Test')
    ...
    def test_false_if_not_all_majors_present(self):
        ...
        self.patient.update('no2', 1)
        self.assertFalse(self.patient.has_major_params())

        self.patient.update('co3', 1)
        self.assertFalse(self.patient.has_major_params())
